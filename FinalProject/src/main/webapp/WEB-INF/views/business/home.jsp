...
<body>
	...
	<button id="approvalButton">승인확인</button>
	...
	<div
		style="margin: 0 auto; width: 300px; height: 300px; border: 1px solid black; text-align: center; margin-top: 100px; font-family: 'BM HANNA Pro', sans-serif;">${buser.bm_session_id}</div>
