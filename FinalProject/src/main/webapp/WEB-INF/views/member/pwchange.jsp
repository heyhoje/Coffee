...
<body>
	...
	<div class="bg-white rounded shadow-sm container p-3"
		...
		<div class="row mb-3 form-row">
			...
			<div class="col-md-6">
				<input style="width: 653px;" type="email" class="form-control" id="me_pw" name="me_pw"
		...
		<div class="row mb-3 form-row">
			...
			<div class="col-md-6">
				<input style="width: 653px;" type="email" class="form-control" id="me_pw1" name="me_pw1"
					value="" placeholder="새 비밀번호">
			</div>
		</div>
		<div class="row mb-3 form-row">
			<div class="col-md-3">
			...
			<div class="col-md-6">
				<input style="width: 653px;" type="email" class="form-control" id="me_pw2" name="me_pw2"
					value="" placeholder="새 비밀번호 확인">
			</div>
			<br>
