         ...
         <div class="container-fluid" style="padding-left:0; padding-right:0;">
            ...
            style="background-color: #212529!important;">
              ...
              <ul class="navbar-nav ml-auto">
						...
						<li class="nav-item"><a class="nav-link"
							href="<c:url value='/meetingroom/home'/>"style="font-family: 'BM HANNA Pro', sans-serif; color:white;">미팅룸예약</a></li>
						<li class="nav-item"><a class="nav-link"
						...
						<c:if test="${user != null}">
						<li class="nav-item"><a class="nav-link"
							href="<c:url value='/member/mypage'/>" style="border-radius:10px; border: 1px solid white; margin-right: 8px; color: white; font-family: 'BM HANNA Pro', sans-serif; float: right;">${user.me_name}님 어서오세요</a></li>
